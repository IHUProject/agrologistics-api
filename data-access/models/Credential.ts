...
import { ICredential } from '../../types/interfaces'
import { validateGmail } from '../../common/helpers/validate-schema-properties'
...
const Credential = mongoose.model<ICredential>(
  'Credential',
  credentialSchema
)
